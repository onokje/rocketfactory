...
class Smelting extends Component {
    ...
    render() {
        const {player, science, smelting} = this.props;
        ...
        if (player.initialized && player.tab === 'smelting') {
            return (
                <div className="defaultContainer">
                    ...
                    {playerHasScience(science.sciences, 'steel') ? <div className="simpleDivider">
                    ...
                    {playerHasScience(science.sciences, 'advancedMaterials') ? <div className="simpleDivider">
